  ...
  return (
    <div className="page w-full">
      <div className="relative w-full">
        ...
        <div className="absolute bottom-[16px] right-[20px] flex h-[25px] w-fit items-center rounded-[100px] bg-[rgba(0,0,0,0.5)] px-[16px] text-sm font-medium text-white">
      ...
      <div className="mt-[20px] w-full px-[20px]">
        <ul className="grid w-[75%] gap-[10px]">
          <li className="flex w-full items-start gap-[8px] text-sm font-medium leading-[20px]">
