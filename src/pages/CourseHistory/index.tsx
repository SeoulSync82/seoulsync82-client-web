...
const CourseHistory = () => {
  ...
  return (
    <div className="page px-5">
      {courseHistory?.map(({ course_uuid, course_name, customs, created_at, is_posted }, idx) => (
        <div
          key={course_uuid}
        ...
        >
          ...
          <Button
            ...
            fontSize={12}
            fontWeight="bold"
            textColor={is_posted ? 'gray-900' : 'white'}
            bgColor={is_posted ? 'gray-100' : 'primary'}
...
const CourseSummary = ({
  ...
  <div className="flex flex-col gap-1 py-2">
    ...
    <div className="flex items-center gap-1 text-sm font-semibold text-gray-900">{courseName}</div>
